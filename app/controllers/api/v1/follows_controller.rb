...
module Api
  module V1
    class FollowsController < ApplicationController
      ...
      def create
        # create the follow
        follow = @follower.given_follows
                          .create(follow_params)

        # create a channel and subscriptions so people you follow you can later message quicker
        # but don't create any if those users were talking before
